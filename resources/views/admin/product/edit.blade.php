...
@section('content')
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-title">
                <button class="btn btn-warning"  data-toggle="modal" data-target="#exampleModal">Add Attributes</button>
            </div>
            ...
            <div class="row">
                @foreach ($product->productAttributes as $attribute)
                    <div class="card col-3 p-3 m-3">
                        <div class="card-body">
                            <h5>Name : {{$attribute->name}}</h5>
                            <h5>Quantity : {{$attribute->quantity}}</h5>
                           <a href="{{route('edit.attribute',$attribute->id)}}"> <button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                        </div>
                    </div>
                @endforeach
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Product Attribute</h5>
