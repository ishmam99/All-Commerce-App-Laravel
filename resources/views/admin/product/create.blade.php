        ...
        <div class="kt-portlet__body">
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <div class="input-group">
                    <input name="barcode" id="barcode" value="{{old('barcode') ?? $barcode}}"
                           placeholder="Ex: 012345678901" type="text"
                           class="form-control  @error('barcode') is-invalid @enderror" readonly>
                    <div class="input-group-append">
                      <button type="button" class="input-group-text"
                              onclick="document.getElementById('barcode').removeAttribute('readonly')">
              ...
              <div class="form-group row">
                <label for="name" class="col-md-4 col-form-label"><b>{{__('Product Name')}} <span
                      class="text-danger">*</span></b></label>
                <div class="col-md-8">
                  <input name="name" id="name" value="{{old('name')}}" placeholder="Ex: " type="text"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                      <textarea id="short_description"
                                ...
                                name="short_description" placeholder="Enter a product Short Description..."
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                      <textarea id="full_description"
                                ...
                                name="full_description" placeholder="Enter a product Full Description..."
              ...
              <div class="form-group row">
                <label class="col-md-4 col-form-label" for="category_id"><b>{{__('Product Category')}} <span
                      class="text-danger">*</span></b></label>
                <div class="col-md-8">
                  <select class="form-control select2" multiple name="category_id[]" id='category_id'>
                    @foreach ($categories as $category)
                      <option
                        value="{{ $category->id }}" {{ collect(old('category_id'))->contains($category->id) ? 'selected' : null }}>{{ $category->name }}</option>
                    @endforeach
                  </select>
                  @error('category_id')
                  <span class="text-danger"><strong>{{ $message }}</strong></span>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <select class="form-control select2" multiple name="subcategory_id[]" id="subcategory_id"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <select class="form-control select2" multiple name="sub_subcategory_id[]" id="sub_subcategory_id"
                          disabled="disabled"></select>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input name="quantity" id="quantity" value="{{old('quantity')}}" placeholder="Ex: 100" type="number"
                ...
                <div class="col-md-8">
                  <select class="form-control select2-withTag" name="unit_id" id='unit_id'>
                    @foreach ($units as $unit)
                      <option
                        value="{{ $unit->id }}" {{ collect(old('unit_id'))->contains($unit->id) ? 'selected' : null }}>{{ $unit->name }}</option>
                    @endforeach
                  </select>
                  @error('unit_id')
                  <span class="text-danger"><strong>{{ $message }}</strong></span>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input name="stock" id="stock" value="{{old('stock')}}" placeholder="Ex: 100" type="number"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <select class="form-control select2-withTag" id="tag_id" multiple name="tag_id[]">
                    @foreach ($tags as $tag)
                      <option
                        value="{{ $tag->id }}" {{ collect(old('tag_id'))->contains($tag->id) ? 'selected' : null }}>{{ $tag->name }}</option>
                    @endforeach
                  </select>
                  @error('tag_id')
                  <span class="text-danger"><strong>{{ $message }}</strong></span>
              ...
              <div class="form-group row">
                <label class="col-md-4 col-form-label" for="regular_price"><b>{{__('Selling Price')}} <span
                      class="text-danger">*</span></b></label>
                <div class="col-md-8">
                  <div class="input-group">
                    <input name="regular_price" id="regular_price" value="{{old('regular_price')}}" min="0"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <div class="input-group">
                    <input name="sell_price" id="sell_price" onkeyup="showDiscount()" onchange="showDiscount()"
                           value="{{old('sell_price')}}" min="0" placeholder="Ex: 100" type="number"
              ...
              <!--begin::Repeater-->
              <div class="form-group row">
                <label class="col-md-4 col-form-label" for="discount"><b>{{__('Attribute')}}</b></label>
                <div class="col-md-8">
                  <!--begin::Repeater-->
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <div class="input-group">
                    <input name="discount" id="discount" onkeyup="showSellPrice()" onchange="showSellPrice()"
                           value="{{old('discount')}}" min="0" max="100" placeholder="Ex: 5" type="number"
                ...
                <div class="col-md-8">
                  <div class="image-input image-input-outline">
                    ...
                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                           data-action="change" data-toggle="tooltip" title="" d>
                      <i class="fa fa-pen icon-sm text-muted"></i>
                      <input type="file" class="@error('image') is-invalid @enderror" onchange="readURL(this,'#image')"
              ...
              <div class="form-group row">
                ...
                <div class="image-input image-input-outline">
                  ...
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                    ...
                    <i class="fa fa-pen icon-sm text-muted"></i>
                    <input type="file" value="{{old('gallery')}}" class="@error('gallery') is-invalid @enderror"
                           onchange="readURL(this, '#gallery1')" name="gallery[]" accept=".png, .jpg, .jpeg"/>
                  </label>
              ...
              <div class="form-group row">
                <div class="image-input image-input-outline">
                  ...
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                    ...
                    <i class="fa fa-pen icon-sm text-muted"></i>
                    <input type="file" value="{{old('gallery')}}" class="@error('gallery') is-invalid @enderror"
                           onchange="readURL(this, '#gallery2')" name="gallery[]" accept=".png, .jpg, .jpeg"/>
                  </label>
              ...
              <div class="form-group row">
                <div class="image-input image-input-outline">
                  ...
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                    ...
                    <i class="fa fa-pen icon-sm text-muted"></i>
                    <input type="file" value="{{old('gallery')}}" class="@error('gallery') is-invalid @enderror"
                           onchange="readURL(this, '#gallery3')" name="gallery[]" accept=".png, .jpg, .jpeg"/>
                  </label>
              ...
              <div class="form-group row">
                <div class="image-input image-input-outline">
                  ...
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                    ...
                    <i class="fa fa-pen icon-sm text-muted"></i>
                    <input type="file" value="{{old('gallery')}}" class="@error('gallery') is-invalid @enderror"
                           onchange="readURL(this, '#gallery4')" name="gallery[]" accept=".png, .jpg, .jpeg"/>
                  </label>
              ...
              <div class="form-group row">
                <div class="image-input image-input-outline">
                  ...
                  <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                    ...
                    <i class="fa fa-pen icon-sm text-muted"></i>
                    <input type="file" value="{{old('gallery')}}" class="@error('gallery') is-invalid @enderror"
                           onchange="readURL(this, '#gallery5')" name="gallery[]" accept=".png, .jpg, .jpeg"/>
                  </label>
