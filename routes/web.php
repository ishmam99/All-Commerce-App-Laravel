...
use App\Http\Controllers\Dashboard\PrebookController;
...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    ...
    // Route::get('order/search',[OrderController::class, 'productWiseOrderSearch']);
...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    ...
    Route::resource('prebook', PrebookController::class);
    ...
    Route::get('product/orders/{product}',[ProductController::class,'orders'])->name('product.orders');
    ...
    Route::post('product/attribute/{product}',[ProductController::class, 'storeAttribute'])->name('store.attribute');
    Route::get('attribute/edit/{productAttribute}',[ProductController::class,'editAttribute'])->name('edit.attribute');
    Route::post('attribute/update/{productAttribute}',[ProductController::class,'updateAttribute'])->name('update.attribute');
