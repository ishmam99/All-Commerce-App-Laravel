...
class SaleController extends Controller
{
    ...
    {
        Utilities::checkPermissions(['sell.all', 'sell.add', 'sell.view', 'sell.edit', 'sell.delete']);
        ...
        return response()->view('admin.sale.index', compact('sales', 'stores', 'store'));
    }

    public function create()
    {
        Utilities::checkPermissions(['sell.all', 'sell.add']);
    ...
    {
        Utilities::checkPermissions(['sell.all', 'sell.view', 'sell.edit']);
        $store = Utilities::getActiveStore();
    ...
    {
        Utilities::checkPermissions(['sell.all', 'sell.delete']);
