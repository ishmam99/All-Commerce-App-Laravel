...
class CoreDataSeeder extends Seeder
{
    ...
    {
        $jsonString = file_get_contents(public_path('geoinfo/bd-divisions.json'));
        $data = json_decode($jsonString, true);
        Division::insert($data['divisions']);

        $jsonString = file_get_contents(public_path('geoinfo/bd-districts.json'));
        $data = json_decode($jsonString, true);
        District::insert($data['districts']);

        $jsonString = file_get_contents(public_path('geoinfo/bd-upazilas.json'));
        $data = json_decode($jsonString, true);
